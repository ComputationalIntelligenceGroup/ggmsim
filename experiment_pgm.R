...
ggmexp::execute_experiment(p = p, d = d, r = r, ename = "diagdom",
								emethod = gmat::diagdom, N = N)
ggmexp::execute_experiment(p = p, d = d, r = r, ename = "port", 
...
ggmexp::execute_experiment(p = p, d = d, r = r, ename = "time_diagdom",
								emethod = get_time, method = gmat::diagdom, N = N)
ggmexp::execute_experiment(p = p, d = d, r = r, ename = "time_port", 
