...
dname <- "sim"
ggmexp::execute(p = p, d = d, r = r, dir = dname, ename = "diagdom",
								emethod = gmat::diagdom, N = N)
ggmexp::execute(p = p, d = d, r = r, dir = dname, ename = "port", 
...
dname <- "time"
ggmexp::execute(p = p, d = d, r = r, dir = dname, ename = "t_diagdom",
								emethod = get_time, method = diagdom, N = N)
ggmexp::execute(p = p, d = d, r = r, dir = dname, ename = "t_port", 
